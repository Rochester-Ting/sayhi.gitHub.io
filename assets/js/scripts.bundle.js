...
var KTApp = function () {
    var t = {}, e = function (t) {
        ...
        var e = t.data("skin") ? "popover-" + t.data("skin") : "", a = t.data("trigger") ? t.data("trigger") : "hover";
        t.popover({
            trigger: a,
    ...
    return {
        init: function (e) {
            ...
            var a, n = $(t), i = '<span class="spinner ' + ((e = $.extend(!0, {
                opacity: .05,
                overlayColor: "#000000",
                type: "",
                size: "",
...
var KTCard = function (t, e) {
    var a = this, n = KTUtil.getById(t), i = KTUtil.getBody();
    if (n) {
        var o = {toggleSpeed: 400, sticky: {releseOnReverse: !1, offset: 300, zIndex: 101}}, l = {
...
var KTCookie = {
    getCookie: function (t) {
        ...
        a || (a = {}), (a = Object.assign({}, {path: "/"}, a)).expires instanceof Date && (a.expires = a.expires.toUTCString());
...
var KTDialog = function (t) {
    var e, a = this, n = KTUtil.getBody(),
        i = {placement: "top center", type: "loader", width: 100, state: "default", message: "Loading..."}, o = {
            construct: function (t) {
                return o.init(t), a
            }, init: function (t) {
...
var KTHeader = function (t, e) {
    var a = this, n = KTUtil.getById(t), i = KTUtil.getBody();
    if (void 0 !== n) {
        var o = {offset: {desktop: !0, tabletAndMobile: !0}, releseOnReverse: {desktop: !1, tabletAndMobile: !1}}, l = {
            construct: function (t) {
...
var KTMenu = function (t, e) {
    var a = this, n = !1, i = KTUtil.getById(t), o = KTUtil.getBody();
    if (i) {
        var l = {
            ...
            construct: function (t) {
                ...
                if ("accordion" !== r.getSubmenuMode(e)) {
                    ...
                    if (a.length > 0 && !1 === KTUtil.hasClass(e, "menu-toggle") && 0 === e.querySelectorAll(".menu-toggle").length) for (var n = 0, o = a.length; n < o; n++) r.hideSubmenuDropdown(a[0], !0)
                }
                ...
                if (!1 !== r.eventTrigger("submenuToggle", this, t)) if ("dropdown" === r.getSubmenuMode(e) && (n = i.closest(".menu-item")) && "accordion" != n.getAttribute("data-menu-submenu-mode")) t.preventDefault(); else {
                    var o = i.closest(".menu-item"), l = KTUtil.child(o, ".menu-submenu, .menu-inner");
                        ...
                        if (!1 === KTUtil.hasClass(o, "menu-item-open")) {
                            if (!1 === a.options.accordion.expandAll) {
                                ...
                                if (d && c) for (var u = 0, p = c.length; u < p; u++) {
                                    var f = c[0], g = KTUtil.child(f, ".menu-submenu");
                ...
                var t;
                if (t = i.querySelectorAll('.menu-item-submenu.menu-item-hover:not(.menu-item-tabs):not([data-menu-toggle="tab"])')) for (var e = 0, a = t.length; e < a; e++) r.hideSubmenuDropdown(t[e], !0)
                ...
                if (!1 === a.options.accordion.expandAll && (e = i.querySelectorAll(".menu-item-open"))) for (o = 0, l = e.length; o < l; o++) KTUtil.removeClass(n[0], "menu-item-open")
                ...
                var e, a = [], n = KTUtil.child(t, ".menu-link");
                a.push({
    ...
    if (n) {
        var o = {attrCustom: ""}, l = {
            construct: function (t) {
                ...
                })); else if (a.options.toggleBy && a.options.toggleBy[0]) if (a.options.toggleBy[0].target) for (var t in a.options.toggleBy) KTUtil.addEvent(KTUtil.getById(a.options.toggleBy[t].target), "click", (function (t) {
                    t.preventDefault(), a.target = this, l.toggle()
                })); else for (var t in a.options.toggleBy) KTUtil.addEvent(KTUtil.getById(a.options.toggleBy[t]), "click", (function (t) {
                    t.preventDefault(), a.target = this, l.toggle()
                ...
                if (a.options.toggleBy && a.options.toggleBy[0] && a.options.toggleBy[0].target) for (var i in a.options.toggleBy) a.options.toggleBy[i].target === n && (e = a.options.toggleBy[i]); else a.options.toggleBy && a.options.toggleBy.target && (e = a.options.toggleBy);
                if (e) {
...
var KTToggle = function (t, e, a) {
    var n = this, i = t, o = e;
    if (i) {
        var l = {targetToggleMode: "class"}, r = {
            construct: function (t) {
                ...
                return n.events.push({name: t, handler: e, one: a, fired: !1}), n
            }
        };
...
var KTUtil = function () {
    var t = [], e = {sm: 544, md: 768, lg: 992, xl: 1200}, a = function () {
    ...
    return {
        init: function (t) {
            ...
            for (var e = 1; e < arguments.length; e++) {
                var a = arguments[e];
                if (a) for (var n in a) a.hasOwnProperty(n) && ("[object Object]" !== Object.prototype.toString.call(a[n]) ? t[n] = a[n] : t[n] = KTUtil.deepExtend(t[n], a[n]))
            }
            return t
        }, extend: function (t) {
            t = t || {};
            ...
            for (var e = t.parentNode.children, a = 0; a < e.length; a++) if (e[a] == t) return a
        }, trim: function (t) {
            return t.trim()
            ...
            function a() {
                ...
                } else (a = KTUtil.data(t).get("ps")) ? (e.resetHeightOnDestroy ? KTUtil.css(t, "height", "auto") : (KTUtil.css(t, "overflow", "auto"), n > 0 && KTUtil.css(t, "height", n + "px")), a.destroy(), a = KTUtil.data(t).remove("ps")) : n > 0 && (KTUtil.css(t, "overflow", "auto"), KTUtil.css(t, "height", n + "px")); else KTUtil.scrollDestroy(t, !0)
            }
            ...
            a = a || 0;
            var n = KTUtil.getViewPort().width, i = KTUtil.getViewPort().height, o = KTUtil.offset(t).top,
                l = KTUtil.outerHeight(t) + a, r = KTUtil.offset(t).left, s = KTUtil.outerWidth(t) + a;
            if ("bottom" == e) {
                if (i < o + l) return !0;
...
var KTWizard = function (t, e) {
    ...
    KTUtil.getBody();
    if (n) {
        var i = {startStep: 1, clickableSteps: !1}, o = {
            construct: function (t) {
                ...
                if (n && n.length > 0) for (var i = 0, l = n.length; i < l; i++) i == e ? KTUtil.attr(n[i], "data-wizard-state", "current") : i < e ? KTUtil.attr(n[i], "data-wizard-state", "done") : KTUtil.attr(n[i], "data-wizard-state", "pending");
                var r = KTUtil.findAll(a.element, '[data-wizard-type="step-info"]');
                if (r && r.length > 0) for (i = 0, l = r.length; i < l; i++) i == e ? KTUtil.attr(r[i], "data-wizard-state", "current") : KTUtil.removeAttr(r[i], "data-wizard-state");
                var s = KTUtil.findAll(a.element, '[data-wizard-type="step-content"]');
                if (s && s.length > 0) for (i = 0, l = s.length; i < l; i++) i == e ? KTUtil.attr(s[i], "data-wizard-state", "current") : KTUtil.removeAttr(s[i], "data-wizard-state")
...
"undefined" != typeof module && void 0 !== module.exports && (module.exports = KTWizard), function (t) {
    var e = "KTDatatable", a = KTUtil, n = KTApp;
    ...
    t.fn.KTDatatable = function (i) {
        if (0 !== t(this).length) {
            ...
            var l = {
                ...
                extractTable: function () {
                    var e = [], n = t(o).find("tr:first-child th").get().map((function (a, n) {
                        var o = t(a).data("field"), l = t(a).data("title");
                        void 0 === o && (o = t(a).text().trim()), void 0 === l && (l = t(a).text().trim());
                        var r = {field: o, title: l};
                ...
                layoutUpdate: function () {
                    l.setupSubDatatable.call(), l.setupSystemColumn.call(), l.setupHover.call(), void 0 === i.detail && 1 === l.getDepth() && l.lockTable.call(), l.resetScroll(), l.isLocked() || (l.redraw.call(), l.isSubtable() || !0 !== l.getOption("rows.autoHide") || l.autoHide(), t(o.table).find(".datatable-row").css("height", "")), l.columnHide.call(), l.rowEvenOdd.call(), l.sorting.call(), l.scrollbar.call(), l.isInit || (l.dropdownFix(), t(o).trigger("datatable-on-init", {
                        ...
                        options: i
                    }), l.isInit = !0), t(o).trigger("datatable-on-layout-updated", {table: t(o.wrap).attr("id")})
                },
                ...
                lockEnabledColumns: function () {
                    var e = t(window).width(), n = i.columns, o = {left: [], right: []};
                ...
                adjustLockContainer: function () {
                    ...
                    var e = t(o.tableHead).width(), a = t(o.tableHead).find(".datatable-lock-left").width(),
                ...
                dragResize: function () {
                    ...
                    t(o.tableHead).find(".datatable-cell").mousedown((function (o) {
                        ...
                        if (n) {
                            var r = t(i).index(), s = t(o.tableBody), d = t(i).closest(".datatable-lock");
                            if (d) {
                                var c = t(d).index();
                ...
                initHeight: function () {
                    if (i.layout.height && i.layout.scroll) {
                        var e = t(o.tableHead).find(".datatable-row").outerHeight(),
                            a = t(o.tableFoot).find(".datatable-row").outerHeight(), n = i.layout.height;
                ...
                scrollbar: function () {
                    var e = {
                        scrollable: null, tableLocked: null, initPosition: null, init: function () {
                            ...
                            var i = t(this).scrollLeft(), o = t(this).scrollTop();
                ...
                setHeadTitle: function (e) {
                    ...
                    var n = i.columns, r = e.getElementsByTagName("tr")[0], s = e.getElementsByTagName("td");
                ...
                dataRender: function (e) {
                    ...
                    var a = function () {
                        ...
                        var a = Math.max(e.perpage * (e.page - 1), 0), n = Math.min(a + e.perpage, e.total);
                        ...
                        var n = function (e, a) {
                            ...
                            var n = Math.max(a.perpage * (a.page - 1), 0), i = Math.min(n + a.perpage, a.total);
                            l.localDataUpdate(), o.dataSet = t(o.dataSet).slice(n, i), l.insertData()
                        };
                        if (t(o.wrap).removeClass("datatable-error"), i.pagination) if (i.data.serverPaging && "local" !== i.data.type) {
                            var r = l.getObject("meta", e || null);
                            l.pagingObject = null !== r ? l.paging(r) : l.paging(a(), n)
                        } else l.pagingObject = l.paging(a(), n); else l.localDataUpdate();
                        l.insertData()
                    };
                ...
                insertData: function () {
                    o.dataSet = o.dataSet || [];
                    var e = l.getDataSourceParam(), n = e.pagination, r = (Math.max(n.page, 1) - 1) * n.perpage,
                        s = Math.min(n.page, n.pages) * n.perpage, d = {};
                ...
                paging: function (e, n) {
                    var i = {
                        ...
                        pagingBreakpoint: function () {
                            ...
                            if (0 !== t(e).length) {
                                var n = l.getCurrentPage(), r = t(e).find(".datatable-pager-input").closest("li");
                ...
                columnHide: function () {
                    ...
                    t.each(i.columns, (function (n, i) {
                        if (void 0 !== i.responsive || void 0 !== i.visible) {
                            var r = i.field, s = t.grep(t(o.table).find(".datatable-cell"), (function (e, a) {
                ...
                setupSubDatatable: function () {
                    ...
                    if ("function" == typeof e && !(t(o.table).find(".datatable-subtable").length > 0)) {
                        ...
                        var a = function (a) {
                            a.preventDefault();
                            var n = t(this).closest(".datatable-row"), r = t(n).next(".datatable-row-subtable");
                ...
                sortCallback: function (e, a, n) {
                    var i = n.type || "string", o = n.format || "", l = n.field;
                ...
                autoHide: function () {
                    var e = !1, a = t(o.table).find("[data-autohide-enabled]");
                    a.length && (e = !0, a.hide());
                    var n = function (e) {
                        e.preventDefault();
                        var a = t(this).closest(".datatable-row"), n = t(a).next();
                        if (t(n).hasClass("datatable-row-detail")) t(this).find("i").removeClass(l.getOption("layout.icons.rowDetail.expand")).addClass(l.getOption("layout.icons.rowDetail.collapse")), t(n).remove(); else {
                            ...
                            var r = t("<td/>").addClass("datatable-detail").attr("colspan", l.getTotalColumns()).appendTo(n),
                                s = t("<table/>");
                            t(o).each((function () {
                                var e = t(this).data("field"), a = t.grep(i.columns, (function (t, a) {
                                    return e === t.field
                                }))[0];
                ...
                sortColumn: function (e, a, n) {
                    ...
                    var i = t(e).index(), l = t(o.tableBody).find(".datatable-row"),
                ...
                sorting: function () {
                    var e = {
                        init: function () {
                            ...
                            if (!t.isEmptyObject(e)) {
                                ...
                                if (void 0 !== a && !(void 0 !== a.sortable && !1 === a.sortable || void 0 !== a.selector && !0 === a.selector)) {
                                    var n = t(o.tableHead).find('.datatable-cell[data-field="' + e.field + '"]').attr("data-sort", e.sort),
                                        i = t(n).find("span"), r = t(i).find("i"), s = l.getOption("layout.icons.sort");
                            ...
                            var r = l.getDataSourceParam("sort"), s = t(this).data("field"), d = l.getColumnByField(s);
                ...
                localDataUpdate: function () {
                    ...
                    var a = l.getObject("sort.field", e), n = l.getObject("sort.sort", e), i = l.getColumnByField(a);
                ...
                getHiddenDimensions: function (e, a) {
                    var n = {position: "absolute", visibility: "hidden", display: "block"},
                        i = {width: 0, height: 0, innerWidth: 0, innerHeight: 0, outerWidth: 0, outerHeight: 0},
                ...
                search: function (e, a) {
                    void 0 !== a && (a = t.makeArray(a)), n = function () {
                        ...
                        }))), l.setDataSourceQuery(n), o.setDataSourceParam("pagination", Object.assign({}, o.getDataSourceParam("pagination"), {page: 1})), i.data.serverFiltering || l.localDataUpdate(), l.dataRender("search")
            ...
            }, i = t.extend(!0, {}, t.fn.KTDatatable.defaults, i), o.options = i, l.init.apply(this, [i]), t(o.wrap).data(e, o)); else void 0 === (o = t(this).data(e)) && t.error("KTDatatable not initialized"), i = o.options;
            return o
        }
        ...
        layout: {
            ...
            header: !0,
            customScrollbar: !0,
            spinner: {overlayColor: "#000000", opacity: 0, type: "loader", state: "primary", message: !0},
            icons: {
        ...
        editable: !1,
        columns: [],
        search: {onEnter: !1, input: null, delay: 400, key: null},
        rows: {
            callback: function () {
    ...
    return {
        init: function (a) {
            ...
            (t = KTUtil.getById(a), KTUtil.getBody(), t) && (n = KTUtil.hasClass(t, "aside-offcanvas-default") ? "aside-offcanvas-default" : "aside", e = new KTOffcanvas(t, {
                ...
                toggleBy: {target: "kt_aside_mobile_toggle", state: "mobile-toggle-active"}
            }), (i = KTUtil.find(t, ".aside-nav")) && KTUtil.scrollInit(i, {
                disableForMobile: !0,
                resetHeightOnDestroy: !0,
                handleWindowResize: !0,
                height: function () {
                    var e = parseInt(KTUtil.getViewPort().height), a = KTUtil.find(t, ".aside-brand"),
                        n = KTUtil.find(t, ".aside-footer");
    ...
    return {
        init: function (i, o) {
            t = KTUtil.getById(i), a = KTUtil.getById(o), t && (n = new KTOffcanvas(a, {
                ...
                toggleBy: {target: "kt_header_mobile_toggle", state: "mobile-toggle-active"}
            }), (e = new KTMenu(t, {
                ...
                sticky: {
                    ...
                    position: {
                        top: function () {
                            ...
                            var a = KTUtil.getBody(), n = parseInt(KTUtil.css(t, "width"));
...
var KTLayoutStretchedCard = function () {
    var t, e = function () {
        var e = KTUtil.find(t, ".card-scroll"), a = KTUtil.find(t, ".card-body"), n = KTUtil.find(t, ".card-header"),
...
var KTLayoutAdvanceSearch = function () {
    var t = !1, e = "", a = function () {
        if (L) {
            var t, a = L.map("kt_subheader_leaflet", {center: [40.725, -73.985], zoom: 30});
            L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {attribution: '&copy; <a href="https://osm.org/copyright">OpenStreetMap</a> contributors'}).addTo(a), t = void 0 === L.esri.Geocoding ? L.esri.geocodeService() : L.esri.Geocoding.geocodeService();
            var n = L.layerGroup().addTo(a), i = L.divIcon({
            ...
            a.on("click", (function (a) {
                t.reverse().latlng(a.latlng).run((function (t, a) {
                    t || (n.clearLayers(), e = a.address.Match_addr, L.marker(a.latlng, {icon: i}).addTo(n).bindPopup(a.address.Match_addr, {closeButton: !1}).openPopup())
                }))
            }))
        }
    };
    return {
        init: function () {
            "undefined" != typeof L && function () {
                const n = "kt_searchbar_7_category-options";
                $(`#${n}`).find(".dropdown-item").click((function () {
                    const t = $(this).text();
                    $(`input[data-target="${n}"`).val(t)
                })), $("#subheader7Modal").on("shown.bs.modal", (function (e) {
                    t || (a(), t = !0)
                })), $("#subheader7Modal").find("#submit").click((function () {
                    "" != e && $("#kt_subheader_7_location").val(e)
                }))
            }()
        }
    }
}();
"undefined" != typeof module && (module.exports = KTLayoutAdvanceSearch);
var KTLayoutChat = function () {
    var t = function (t) {
        var a = KTUtil.find(t, ".scroll"), n = KTUtil.find(t, ".card-body"), i = KTUtil.find(t, ".card-header"),
        ...
        var e = KTUtil.find(t, ".messages"), a = KTUtil.find(t, ".scroll"), n = KTUtil.find(t, "textarea");
        if (0 !== n.value.length) {
        ...
        init: function (e) {
            t(KTUtil.getById(e)), "keenthemes.com" != encodeURI(window.location.hostname) && "www.keenthemes.com" != encodeURI(window.location.hostname) || setTimeout((function () {
                if (!KTCookie.getCookie("kt_app_chat_shown")) {
                    ...
                    KTCookie.setCookie("kt_app_chat_shown", 1, {expires: t}), KTUtil.getById("kt_app_chat_launch_btn") && KTUtil.getById("kt_app_chat_launch_btn").click()
                }
            }), 2e3)
        }, setup: function (e) {
            t(e)
    ...
    return {
        init: function (a) {
            (t = KTUtil.getById(a)) && (!function () {
                ...
                var a = KTUtil.find(t, ".offcanvas-header"), n = KTUtil.find(t, ".offcanvas-content"),
                    i = KTUtil.find(t, ".offcanvas-wrapper"), o = KTUtil.find(t, ".offcanvas-footer");
                KTUtil.scrollInit(i, {
                    disableForMobile: !0,
                    resetHeightOnDestroy: !0,
                    handleWindowResize: !0,
                    ...
                    var t = new Date((new Date).getTime() + 36e5);
                    KTCookie.setCookie("kt_demo_panel_shown", 1, {expires: t})
                }))
                ...
                if (!KTCookie.getCookie("kt_demo_panel_shown")) {
                    ...
                    KTCookie.setCookie("kt_demo_panel_shown", 1, {expires: t}), void 0 !== e && e.show()
                }
            }), 4e3))
        }
    }
    ...
    init: function (t, e) {
        !function (t) {
            ...
            if (void 0 === e && (e = document.querySelectorAll(".example:not(.example-compact):not(.example-hover):not(.example-basic)")), e && e.length > 0) for (var a = 0; a < e.length; ++a) {
                var n = e[a], i = KTUtil.find(n, ".example-copy");
                i && new ClipboardJS(i, {
                    target: function (t) {
                        var e = t.closest(".example"), a = KTUtil.find(e, ".example-code .tab-pane.active");
            ...
            if (e && e.length > 0) for (var a = 0; a < e.length; ++a) {
                var n = e[a], i = KTUtil.find(n, ".example-toggle"), o = KTUtil.find(n, ".example-copy");
                KTUtil.addEvent(i, "click", (function () {
                    var t = this.closest(".example"), e = KTUtil.find(t, ".example-code"), a = this;
    ...
    return {
        init: function (e) {
            (t = KTUtil.getById(e)) && function () {
                ...
                var e = KTUtil.find(t, ".offcanvas-header"), a = KTUtil.find(t, ".offcanvas-content"),
                    n = KTUtil.find(t, ".offcanvas-wrapper"), i = KTUtil.find(t, ".offcanvas-footer");
                KTUtil.scrollInit(n, {
                    disableForMobile: !0,
                    resetHeightOnDestroy: !0,
                    handleWindowResize: !0,
...
var KTLayoutScrolltop = function () {
    ...
    return {
        init: function (e) {
            (t = KTUtil.getById(e)) && new KTScrolltop(t, {offset: 300, speed: 600})
        }, getElement: function () {
            return t
        }
    }
...
var KTLayoutSearch = function () {
    var t, e, a, n, i, o, l, r, s = "", d = !1, c = !1, u = !1, p = "spinner spinner-sm spinner-primary",
        f = "quick-search-has-result", g = function () {
            ...
            s = a.value, KTUtil.removeClass(t, f), u = !0, KTUtil.addClass(r, p), n && KTUtil.hide(n), h(), setTimeout((function () {
                $.ajax({
                    url: HOST_URL + "/api/quick_search.php", data: {query: s}, dataType: "html", success: function (e) {
...
var KTLayoutSearchInline = KTLayoutSearch, KTLayoutSearchOffcanvas = KTLayoutSearch;
